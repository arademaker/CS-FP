...
snowwhite = Branch "S" [Branch "NP" [Leaf "Snow White"],
...
-- define dominance as trans/closure immdominance (?)
...
mutualcCommand t = [ (p,q) | (p,q) <- cCommand t, (q,p) `elem` cCommand t ]
...
lexicon "kicked" = 
 [Cat "kicked" "VP" [Tense] [Cat "_" "NP" [AccOrDat] [],
  ...
  Cat "kicked" "VP" [Tense] [Cat "_" "NP" [AccOrDat] []]]
lexicon "kick" = 
 [Cat "kick"   "VP" [Infl]  [Cat "_" "NP" [AccOrDat] [], Cat "_" "PP" [With]     []], 
  Cat "kick"   "VP" [Infl]  [Cat "_" "NP" [AccOrDat] []]] 

lexicon "took" = 
 [Cat "took" "VP" [Tense] [Cat "_" "NP" [AccOrDat] [], Cat "_" "PP" [From]     []], 
